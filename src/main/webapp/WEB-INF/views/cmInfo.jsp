...
<body>
   ...
   <section>
      <div class="contents_box">
            ...
            <dl id="left_nav" style="margin-top: 100px;">
               ...
               <dd>
                  <a href="javascript:void(0)"
                     onclick="javascript:$('input[name=PARENT_MENU_CD]').val('');$('input[name=LEFT_MENU_CD]').val('G1002');$('input[name=TOP_MENU_CD]').val('G1000');goMenu('G1002','http://localhost/controller/cmInfo2');">파트너사 소개
                  </a>
               </dd>
         ...
         <img src="resources/images/information1.jpg" style="margin-left: 30%; margin-top: -15%;">
         <img src="resources/images/information2.jpg" style="margin-left: 30%;"> 
         <img src="resources/images/information3.jpg" style="margin-left: 30%;">
      </div>
   </section>
   <footer>

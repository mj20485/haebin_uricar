...
<link rel="stylesheet" href="resources/css/sojin/style-writeFrm.css" />
</head>
<body>
	<header>
	...
	<section>
		...
		method="post" enctype="multipart/form-data">
				...
				<input type="text" class="write-input" name="title" autofocus placeholder="제목" required>
				...
				<div class="t">
				<textarea name="b_content" rows="15" class="write-text"
					placeholder="내용을 적어주세요 필요시 사진파일도 업로드해주세요."></textarea>
				<div class="filebox">
					<label for="file">업로드</label> 
					<input type="file" name="files" id="file">
					<input class="uplaod-name" value="파일선택" readonly> 
				...
				<div class="btn-area">
					...
					<input class="btn-write1" type="reset" value="전체지우기"> 

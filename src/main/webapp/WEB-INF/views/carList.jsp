...
<link rel="stylesheet" href="resources/css/footer.css" />
<link rel="stylesheet" href="resources/css/sojin/style-carList.css" />
<script type="text/javascript">
...
<div class="wrap">
   ...
   <div class="content">
      ...
      <div class="data-area">
         <div class="title-row">
            <div class="t-no p-10">차량 번호</div>
            <div class="t-title p-30">차종</div>
            <div class="t-name p-15">제공회사</div>
            <div class="t-date p-30">위치</div>
         </div>
         <c:forEach var="citem" items="${cList}">
         <div class="data-row">
            <div class="t-no p=10">${citem.car_num}</div>
            <div class="t-title p-30"><a href="contents?car_seq=${citem.car_seq}">
               ${citem.car_type}</a></div>
            <div class="t-name p-15">${citem.cid}</div>
            <div class="t-date p-30">${citem.zone}</div>

         ...
         <div id="article_area" style="margin-top: -35%; margin-right: 20%;">
            <div id="contents_wrap">
               ...
               <div class="contents_header">
                  <h2 style="margin-top: 280px;">아이디 찾기</h2>
               </div>
               <div class="contents">
                  <hr />
                  <form name="mainform" id="mainform" method="post"
                     ...
                     <div id="contents">
                        <br />
                        <table style="margin-bottom: 10%; margin-top:40%;">
                           <tr>
                              <td>
                              <img src="resources/images/id_find.jpg" alt="" usemap="#map01" />
                                 <map name="map01" id="map01">
                                    <area shape="rect" coords="8,240,303,293" href="./id_find">
                                 </map></td>
                              <td align="center">
                              <img src="resources/images/cmid_find.jpg" alt="" usemap="#map02" />
                                 <map name="map02" id="map02">
                                    <area shape="rect" coords="7,239,303,292" href="./cmId_find">
                                 </map></td>
                           </tr>
                           </div>
                        </table>

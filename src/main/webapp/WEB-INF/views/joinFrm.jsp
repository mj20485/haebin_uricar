...
<body>
   ...
   <div id="contents_wrapper">
      <div class="contents_box">
         <div id="menuLeft">
            <!-- snb 시작 -->
            <dl id="left_nav" style="margin-top: 200px;">
               <dt class="">회원관리</dt>
               <dd>
         ...
         <div id="article_area" style="margin-top: -30%; margin-right: 20%;">
            ...
            <div id="contents_wrap">
               ...
               <div class="contents">
                  ...
                  <form name="mainform" id="mainform" method="post"
                     action="KHMMMJ009M.html">
                     <!-- contents 시작 -->
                     <div id="contents">
                        <div class="section join01">

                           <ul class="join_step" style="margin-top:65px; margin-left: 20px;">
                              <li><img src="resources/images/join_step_01.jpg"
                                 alt="약관동의" title="약관동의" /></li>
                           ...
                           <br />
                           <table style="margin-top: 30px; margin-bottom: 100px; margin-left: 20px;">
                              <tbody align="center">
                                 <tr>
                                    <td align="center"><img
                                       src="resources/images/btn_join_corporate_new.png" alt=""
                                       usemap="#map01" /> <map name="map01" id="map01">
                                          <area shape="rect" coords="8,240,303,293"
                                             href="./cmJoin">
                                       </map></td>
                                    <td align="center"><img
                                       src="resources/images/btn_join_individual_new.png" alt=""
                                       usemap="#map02" /> <map name="map02" id="map02">
                                          <area shape="rect" coords="7,239,303,292"
                                             href="./mmJoin">
                                       </map></td>
                                 </tr>
                              </tbody>

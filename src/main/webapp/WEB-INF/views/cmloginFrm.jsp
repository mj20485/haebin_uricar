...
<body class="chrome">
   ...
   <div id="wrap">
      ...
      <!-- header -->
      <a href="./"><img src="resources/images/logoR.png" style="width: 20%;
    height: 25%;
    margin-left: 40%;
    margin-top: 5%;"></a>
      <div id="container">
         ...
         <div id="content">
            ...
            <form id="frmNIDLogin" name="frmNIDLogin" target="_top"
               AUTOCOMPLETE="off" action="caccess" method="post">
               ...
               <input type="hidden" name="bvsd" id="bvsd" value=""> <input
                  ...
                  value="https://localhost/controller/cmloginFrm">
               ...
               <fieldset class="login_form">
                  ...
                  <div class="id_area">
                     <div class="input_row" id="id_area">
                        <span class="input_box"> <label for="id"
                           ...
                           <input type="text" id="id" name="cid" accesskey="L" placeholder="아이디" class="int"
                           maxlength="41" value="">
                        </span>
                     </div>
                  ...
                  <a href="./cmId_find">아이디찾기</a>
                  <a href="./cmPw_find">비밀번호찾기</a>
               </fieldset>
            </form>
         </div>
      </div>

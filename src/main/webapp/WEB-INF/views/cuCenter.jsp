...
<link rel="stylesheet" href="resources/css/sojin/style-cuCenter.css" />
...
<body>
   ...
   <section>
        <div id="menuLeft" style="margin-top: 50px;">
            <!-- snb 시작 -->
            <dl id="left_nav">
               <dt class="">고객센터</dt>
               <dd>
                  <a href="javascript:void(0)" class="on"
                     onclick="javascript:$('input[name=PARENT_MENU_CD]').val('');$('input[name=LEFT_MENU_CD]').val('G1001');$('input[name=TOP_MENU_CD]').val('G1000');goMenu('G1001','http://localhost/controller/cuCenter');">고객센터
                  </a>
               </dd>
               <dd>
                  <a href="javascript:void(0)" 
                     onclick="javascript:$('input[name=PARENT_MENU_CD]').val('');$('input[name=LEFT_MENU_CD]').val('G1002');$('input[name=TOP_MENU_CD]').val('G1000');goMenu('G1002','http://localhost/controller/FAQ');">자추찾는질문
                  </a>
               </dd>
            </dl>
         </div>
      <div class="cuCenter">
         <div class="main">
            <h2 class="cuCenter-header">고객센터 문의</h2>
            <div class="list">
               <div class="table">
                  <div class="t-no p-10">번호</div>
                  <div class="t-view p-15">카테고리</div>
               ...
               <c:forEach var="bitem" items="${bList}">
                  <div class="data-row">
                     <div class="t-no p-10">${bitem.board_seq}</div>
                     <div class="t-view p-15">${bitem.category}</div>
                     <div class="t-title p-30">
                        <a href="b_content?board_seq=${bitem.board_seq}">${bitem.title}</a>
                     </div>
                     <div class="t-name p-15">${bitem.bid}</div>
                     <div class="t-date p-30">${bitem.reg_date}</div>
                  </div>
               </c:forEach>
            </div>
            <div class="write">
               <div class="paging">${paging}</div>
               <button class="button" onclick="location.href='./writeFrm'">글쓰기</button>
            </div>
         </div>
      </div>
   </section>

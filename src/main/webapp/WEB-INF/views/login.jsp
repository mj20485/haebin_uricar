...
<body>
   ...
   <table style="margin-bottom: 200px;">
      <tbody align="center">
         <tr>
            <td align="center"><img src="resources/images/loginFrm/companylogin.jpg" alt="" usemap="#map01" style="margin-left: 60%; margin-top: -40%;"/>
            <map name="map01" id="map01">
                  <area shape="rect" coords="8,240,303,293" href="./cmloginFrm">
               </map></td>
            <td align="center">
            <img src="resources/images/loginFrm/memberlogin.jpg" alt="" usemap="#map02" style="margin-right: 40%; margin-top: -40%;"/>
            <map name="map02" id="map02">
                  <area shape="rect" coords="7,239,303,292" href="./loginFrm">
               </map></td>
         </tr>
      </tbody>
   </table>

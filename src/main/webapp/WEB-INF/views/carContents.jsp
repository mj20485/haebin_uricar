...
<link rel="stylesheet"
   href="resources/css/sojin/style-boardContents.css">
      ...
      <center>
         <div class="content">
            <div class="write-form">
               <h2 class="login-header">${car.car_type}</h2>
               <table>
                  <tr height="50">
                     <td width="100" align="center"
                        style="color: #004982; background-color: #F9F9F9;">차량번호</td>
                     <td colspan="5">${car.car_num}</td>
                  </tr>
                  <tr height="50">
                     <td align="center"
                        style="color: #004982; background-color: #F9F9F9;">제공회사</td>
                     <td width="150">${car.cid}</td>
                  </tr>
                  <tr height="50">
                     <td align="center"
                        style="color: #004982; background-color: #F9F9F9;">장소</td>
                     <td width="200">${car.zone}</td>
                  </tr>
                  <tr height="50">
                     <td align="center"
                        style="color: #004982; background-color: #F9F9F9;">차종</td>
                     <td colspan="5">${car.car_type}</td>
                  </tr>
                  <tr height="50">
                     <td align="center"
                        style="color: #004982; background-color: #F9F9F9;">차량크기</td>
                     <td colspan="5">${car.car_size}</td>
                  </tr>
                  <%-- <tr>
                        <th>첨부파일</th>
               ...
               <td colspan="6">
                  ...
                  <tr>
                     <td colspan="6" align="right" style="margin-top: 2%;">
                        ...
                        class="btn-write" id="upbtn"
                           onclick="location.href='./CupdateFrm?car_seq=${car.car_seq}'">수정</button>
                        <button style="margin: 20px" class="btn-write" id="delbtn"
                           onclick="goCdelete(${car.car_seq},'${cm.cid}','${car.cid}')">삭제</button>
                        <button style="margin: 20px" class="btn-sub"
                           onclick="location.href='./clist?pageNum=${pageNum}'">목록으로가기</button>
                     </td>
                  </tr>
               </table>
               <%-- 
...
function replyInsert(board_seq){
   ...
   replyFrm.r_board_seq = board_seq;
   //세션에 저장한 로그인 회원 정보에서 id 추출
   replyFrm.r_id = '${cm.cid}';
...
function goCdelete(car_seq, cid, cmid){
   if(cid != cmid){
   ...
   if(del == true){
      location.href='./cdelete?car_seq=' + car_seq;
   }
   else{
      alert("취소되었습니다.");
   }

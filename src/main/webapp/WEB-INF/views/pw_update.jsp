...
<div class="container">
    ...
    <div class="card">
       <img src="resources/images/logo.png" width="100px" class="logo-center">
        ...
        <form name="pwch" action="passcheck" method="post" onsubmit="return check()1">
           <input type="hidden" name="email" value="${email}">
            <div class="input-container"><input type="password" name="password" id="pw1" required/><label>비밀번호</label>
                <div class="bar"></div>
            </div>

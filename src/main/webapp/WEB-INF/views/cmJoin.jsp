...
<body style="background-color: #FFFFFF">
   ...
   <div id="menuLeft">
      <!-- snb 시작 -->
      <dl id="left_nav" style="margin-top: 20%;">
         <dt class="">회원정보수정</dt>
         <dd>
   ...
   <!-- <div class="section join01">
      ...
      <ul class="join_step">
         ...
         <li><img src="resources/images/join_step_03.jpg" alt="회원정보입력"
            title="회원정보입력" style="margin-top: -60%; margin-left:60%"/></li>
 ...
 -->
      ...
      <br />
   <div class="box0"style="margin-left:30%; margin-top:-10%">
      <form name="cmJoin" action="cmemInsert" method="post"
         >
         <h3>
         ...
         <table brder="" bgcolor="#FFFFFF" cellspacing="1">
            ...
            <tr>
               ...
               <td><input type="text" size="20" class="login-input" id="cid"
                  ...
                  type="button" class="btn_type10" value="중복체크" onclick="cidcheck()" style="text-align: center;">
               </td>
            </tr>

...
<body>
   ...
   <section>
      ...
      <div class="acontents">
         ...
         <form name="cmProfile" action="new_cmpwd" method="post">
		<input type="hidden" name ="cid" value="${cm.cid}">
         <div class="box4">
            <div class="profile-font">
               ...
               <div><input type="password" name="pw" id="password_1" size="32" placeholder="새 비밀번호">
         ...
         <div class="acontents">
            ...
            <div class="box41">
               <div class="profile-font">
                  <p>${cm.address}</p>
                  <form name="cmProfile" action="new_cmaddress" method="post">
                  <input type="hidden" name ="cid" value="${cm.cid}">
            ...
            <div class="box4">
               <div class="profile-font">
                  ...
                  <form name="cmProfile" action="new_cmphone" method="post">
                  <input type="hidden" name="cid" value="${cm.cid}">
            ...
            <div class="box6">
               <div class="profile-font">
                  ...
                  <form name="cmProfile" action="new_cmemail" method="post">
                  <input type="hidden" name ="cid" value="${cm.cid}">
            ...
            <div class="acontents">
               ...
               <div class="box41">
                  <div class="profile-font">
                     <input type="file" /><br>
                     <button style="margin: 10px 0px 10px 500px;">수정취소</button>
                     <button>수정완료</button>
                  </div>
               </div>
            </div>

...
<body>
   ...
   <div id="menuLeft">
         ...
         <div class="ttt">
   <h1 style="margin-top: 12%; margin-bottom: 10px; font-size: 20pt; margin-left: -20%; color:#004982;">기업 아이디 찾기</h1>
   <form class="rFrm">
      기업명 &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; <input type="text" name="cname" id="cname"><br>
      연락처 &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; <input type="text" name="phone" id="phone" placeholder="'-' 생략해주세요." >  <br>
      이메일 &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; <input type="text" name="email" id="email" placeholder="아이디에 기재 된 이메일을 입력해주세요." >  
   </form> 
   </div>
   
   <button id="cmfindId" style="margin-bottom: 10%;">아이디 찾기</button>
...
<script type="text/javascript">
$(document).on('click', '#cmfindId', function(){
   ...
   $.ajax({
      ...
      success:function(data){
         ...
         $("#emailList").append("<h1>"+"회원님의 정보로 등록된 아이디 " + str + "</h1>");
      },

...
<body>
   ...
   <div id="contents_wrapper">
      <div class="contents_box">
         ...
         <div id="article_area" style="margin-top: -35%; margin-right: 20%;">
            <div id="contents_wrap">
               <!-- contnets -->
               <div class="contents_header">
                  <h2 style="margin-top:200;">비밀번호 찾기</h2>
               </div>
               <div class="contents">
                  <hr />
                  <form name="mainform" id="mainform" method="post"
                     ...
                     <div id="contents">
                        <div class="section join01">
                           ...
                           <br />
                           <table style="margin-top: 12%; margin-bottom: 100px; margin-left: 20px;">
                              <tbody align="center">
                                 <tr>
                                    <td align="center"><img
                                       src="resources/images/pw_find.jpg" alt=""
                                       usemap="#map01" /> <map name="map01" id="map01">
                                          <area shape="rect" coords="8,240,303,293"
                                             href="./pw_find">
                                       </map></td>
                                    <td align="center"><img
                                       src="resources/images/cmpw_find.jpg" alt=""
